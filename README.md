...
NOTE: This is fork of the 1.0.0 tagged version of Cowboy.  The only changes are
to the rebar.config to allow pulling via https vs git for use behind a proxy
